...
pg = st.navigation([
    st.Page("./pages/5_Descripcion_del_problema.py", title="Descripción del problema", icon=":material/home:"),
    ...
    st.Page("./pages/6_Conclusiones.py", title="Conclusiones", icon=":material/hub:"),
])
